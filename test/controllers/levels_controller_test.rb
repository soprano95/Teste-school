...
class LevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post levels_url, params: { level: { cycle_id: @level.cycle_id, level_name: @level.level_name } }
    end
  ...
  test "should update level" do
    patch level_url(@level), params: { level: { cycle_id: @level.cycle_id, level_name: @level.level_name } }
