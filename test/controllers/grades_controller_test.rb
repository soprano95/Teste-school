...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { grade_description: @grade.grade_description, grade_name: @grade.grade_name } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { grade_description: @grade.grade_description, grade_name: @grade.grade_name } }
