...
class FilieresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filiere" do
    assert_difference('Filiere.count') do
      post filieres_url, params: { filiere: { filiere_name: @filiere.filiere_name, level_id: @filiere.level_id } }
    end
  ...
  test "should update filiere" do
    patch filiere_url(@filiere), params: { filiere: { filiere_name: @filiere.filiere_name, level_id: @filiere.level_id } }
