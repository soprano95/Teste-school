...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post trainings_url, params: { training: { person_id: @training.person_id, training_name: @training.training_name } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { person_id: @training.person_id, training_name: @training.training_name } }
